...
func (m *UserModel) Create(user *User) error {
	...
	// The query above is a prepared statement. We need to pass in the values
...
// Update the detail of a specific uder
...
// The Set() method is used to set the user's password.
...
// The Matches() method is used to check if the password matches the stored hash.
